    ...
    <footer className='w-full p-4 md:p-8 text-muted-foreground border-t'>
      <div className=' flex flex-col items-center justify-between gap-4 md:flex-row md:gap-0'>
        ...
        <div className='flex items-center gap-4'>
          <Link href='https://www.facebook.com' target='_blank' rel='noopener noreferrer' className='text-muted-foreground hover:text-foreground' prefetch={false}>
          ...
          <Link href='https://www.youtube.com' target='_blank' rel='noopener noreferrer' className='text-muted-foreground hover:text-foreground' prefetch={false}>
          ...
          <Link href='https://www.tiktok.com' target='_blank' rel='noopener noreferrer' className='text-muted-foreground hover:text-foreground' prefetch={false}>
            <svg role='img' viewBox='0 0 24 24' className='w-5 h-5 fill-current' xmlns='http://www.w3.org/2000/svg'>
              <title>TikTok</title>
