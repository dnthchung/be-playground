...
import { useGuestGetOrderListQuery } from '@/hooks/use-guest'
      ...
      {orders.map((order, index) => (
        <div key={order.id} className='flex gap-4'>
          ...
          <div className='flex-shrink-0 relative'>
            <Image src={order.dishSnapshot.image} alt={order.dishSnapshot.name} height={100} width={100} quality={100} className='object-cover w-[80px] h-[80px] rounded-md' />
          </div>
